        ...
        <div class="w">
            ...
            <div class="register clx">
                <div class="reg-tab clx">
                    <a class="fl" href="register.php">
                        新人注册
                    </a>
                    <a class="fl on" href="register_wedding.php">
                        婚礼人注册
                    </a>
                    <span class="fr">
                        已有真喜聚账号，您可以直接
                ...
                <div class="register-l">
                    <form action="" id="validform">
                        ...
                        <div class="register-item clx">
                            ...
                            <div class="register-item-l">
                                <input  type="radio" name="careertype" value="cehuashi"  />
                                策划师
                                <br />
                                <input type="radio" name="careertype" value="zhuchiren" />
                                主持人
                                 <br />
                                <input type="radio" name="careertype" value="huazhuangshi" />
                                化妆师
                                 <br />
                                <input type="radio" name="careertype" value="shexiangshi" />
                                摄像师
                                 <br />
                                <input type="radio" name="careertype" value="sheyingshi" />
                                摄影师
                                 <br />
                                <input type="radio" name="careertype" value="changdibuzhi" />
                                场地布置
                            </div>
                        </div>
                        <div class="register-item clx">
