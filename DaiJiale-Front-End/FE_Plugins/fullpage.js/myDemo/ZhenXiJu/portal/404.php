...
<body class="error">
	...
	<div class="wrapper" id="top">
        ...
        <img class="error__main" src="../images/components/error.png" alt="">
        <h2 class="error__heading">正在努力开发中</h2>
        <p class="error__info">The page you are looking for no longer exists.</p>

        <a class="error__back" href="../index.php">返回首页</a> 
